...
public class AbstractAuditingEntity<ID> extends AbstractPersistableEntity<ID> implements Serializable {
	...
	@CreatedDate
	@Column(name = "created_date", updatable = false, nullable = true, columnDefinition = "DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6)")
	...
	@Column(name = "deleted", columnDefinition = "bit default false", nullable = true)
